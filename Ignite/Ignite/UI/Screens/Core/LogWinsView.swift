        ...
        ZStack {
            ...
            LinearGradient(
                colors: [
                    ...
                    ThemeManager.shared.secondaryBackground
                ],
                startPoint: .top,
                endPoint: .bottom
            )
        ...
        VStack {
            ...
            .background(
                RoundedRectangle(cornerRadius: 12)
                    ...
                    .shadow(color: ThemeManager.shared.shadowColor, radius: 10, x: 0, y: 4)
            )
            ...
            VStack(spacing: 8) {
                ZStack {
                    RoundedRectangle(cornerRadius: 16)
                        .fill(todayProgress.isComplete ? habit.color.opacity(0.15) : ThemeManager.shared.secondaryBackground)
                        .frame(height: 80)
                    ...
                    VStack(spacing: 4) {
                        ...
                        ZStack {
                            if habit.trackingType == .check {
                                ...
                                Circle()
                                    .stroke(todayProgress.isComplete ? habit.color : ThemeManager.shared.dividerColor, 
                                ...
                                ZStack {
                                    Circle()
                                        .stroke(ThemeManager.shared.dividerColor.opacity(0.3), lineWidth: 3)
                                        .frame(width: 44, height: 44)
