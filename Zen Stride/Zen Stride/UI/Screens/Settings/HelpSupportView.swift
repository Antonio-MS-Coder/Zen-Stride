                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 16) {
                            ...
                            Text("Track your daily wins with simplicity")
                                .font(.system(size: 16))
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(spacing: 0) {
                                ContactRow(
                                    icon: "envelope",
                                    title: "Email Support",
                                    subtitle: "support@zenstride.app",
                                    action: {
                                        if let url = URL(string: "mailto:support@zenstride.app") {
                                ...
                                ContactRow(
                                    icon: "link",
                                    title: "Website",
                                    subtitle: "zenstride.app",
                                    action: {
                                        if let url = URL(string: "https://zenstride.app") {
                                            UIApplication.shared.open(url)
                                        }
                                    }
                                )
