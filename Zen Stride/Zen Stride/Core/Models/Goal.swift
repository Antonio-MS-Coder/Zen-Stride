...
extension Goal {
    static let sampleGoals = [
        Goal(
            ...
            updates: [
                GoalUpdate(value: 1, note: "Finished 'Atomic Habits'"),
                GoalUpdate(value: 2, note: "Finished 'Deep Work'"),
                GoalUpdate(value: 3, note: "Finished 'The Lean Startup'")
            ],
            createdDate: Date(),
            isActive: true
        ),
        Goal(
            ...
            updates: [
                GoalUpdate(value: 79.5, note: "Good week!"),
                GoalUpdate(value: 78.2, note: "Steady progress"),
                GoalUpdate(value: 76.5, note: "Feeling great")
            ],
            createdDate: Date(),
            isActive: true
        ),
